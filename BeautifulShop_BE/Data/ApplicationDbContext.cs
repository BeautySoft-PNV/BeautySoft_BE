...
namespace BeautifulShop_BE.Data
{
    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MakeupItemStyleModel>()
                .HasOne(mis => mis.MakeupItem)
                .WithMany(m => m.MakeupItemStyles) 
                .HasForeignKey(mis => mis.MakeupItemId)
                .OnDelete(DeleteBehavior.Restrict);

            modelBuilder.Entity<MakeupItemStyleModel>()
                .HasOne(mis => mis.MakeupStyle)
                .WithMany(ms => ms.MakeupItemStyles)
                .HasForeignKey(mis => mis.MakeupStyleId)
                .OnDelete(DeleteBehavior.Restrict);
